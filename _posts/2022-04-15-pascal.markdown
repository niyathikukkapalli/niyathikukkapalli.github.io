---
layout: post
title: "Blaise Pascal and the Triangle That Bears His Name"
date: 2023-05-10
tags:
  - Math
  - History
...
$\text{\textbf{Pascal's Law:}}$ states that when there is an increase in pressure at any point in a confined fluid, there is an equal increase at every other point in the container. So basically you use the relation, $\frac{F_1}{A_1} = \frac{F_2}{A_2}$

It's much easier with a picture. If you look down below...

<img class="small" loading="lazy" src="/img/car.png">
...
<img class="small" loading="lazy" src="/img/circle2.png">
