---
layout: post
title: "Getting Started with LaTeX: A Beginner's Guide"
date: 2023-04-09
tags:
  - LaTeX
  - Packages
  - Tutorial
categories: LaTeX
description: I've been using LaTeX since 7th grade, and it's one of the best tools I've picked up as a math student. This is the guide I wish I'd had starting out — covering installation, document formatting, essential packages, and a few fun sites that make learning LaTeX actually enjoyable.
...
<img class="large" loading="lazy" src="/img/visual.png">
...
<img class="large" loading="lazy" src="/img/demo.png">
